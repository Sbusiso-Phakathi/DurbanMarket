...
def main():
    ...
    if selected_model == "Onion Brown":
        ...
        with col1:
            ...
            elif Province_brown == "WESTERN CAPE - CERES" and Size_Grade_brown == "1M" and Weight_Kg_brown == 1:
                Low_Price_brown = 6.965517241
            elif Province_brown == "WESTERN CAPE - CERES" and Size_Grade_brown == "1Z" and Weight_Kg_brown == 1:
                Low_Price_brown = 6.3
            elif Province_brown == "WESTERN CAPE - CERES" and Size_Grade_brown == "1S" and Weight_Kg_brown == 1:
                Low_Price_brown = 1
            elif Province_brown == "WESTERN CAPE - CERES" and Size_Grade_brown == "1R" and Weight_Kg_brown == 1:
                Low_Price_brown = 5.333333333
        with col2:    
