...
def main():
    ...
    if selected_model == "Onion Brown":
        ...
        with col1:
            ...
            for i in onionbrowndata:
                if i.Province == Province_brown and i.Size_Grade == Size_Grade_brown and i.Weight_Kg == Weight_Kg_brown:
                    Low_Price_brown = i['AVERAGE of Low_Price']
        with col2:    
